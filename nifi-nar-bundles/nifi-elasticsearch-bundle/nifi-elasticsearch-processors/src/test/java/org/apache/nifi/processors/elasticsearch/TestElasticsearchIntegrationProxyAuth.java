...
public class TestElasticsearchIntegrationProxyAuth {
    private TestRunner runner;
    private static DockerComposeContainer elasticsearchDockerComposeContainer = ElasticsearchDockerInitializer.initiateElasticsearchDockerComposeContainer(DockerComposeContainerType.PROXY_WITH_AUTH);
    private static byte[] docExample;
    private String esUrl = "http://172.18.0.2:9200";
